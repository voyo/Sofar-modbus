...
#     def __init__(self,    ID,name,nod,register,functioncode: int = 3,options=None, Used: int = 1, Description=None, TypeName=None,Type: int = 0, SubType:int = 0 , SwitchType:int = 0  ):
   ...
   # phase R
                ...
                Dev(23,"Current_Output_R",0,1166,functioncode=3,Type=243,SubType=23,Description="Current_Output_R"),
                ...
                Dev(27,"Current_PCC_R",0,1170,functioncode=3,Type=243,SubType=23,Description="Current_PCC_R"),
    ...
    # phase S
                ...
                Dev(32,"Current_Output_S",0,1177,functioncode=3,Type=243,SubType=23,Description="Current_Output_S"),
                ...
                Dev(36,"Current_PCC_S",0,1181,functioncode=3,Type=243,SubType=23,Description="Current_PCC_S"),
    ...
    # phase T
                ...
                Dev(41,"Current_Output_T",0,1188,functioncode=3,Type=243,SubType=23,Description="Current_Output_T"),
                ...
                Dev(45,"Current_PCC_T",0,1192,functioncode=3,Type=243,SubType=23,Description="Current_PCC_T"),
    ...
    # phase R
                ...
                Dev(52,"Current_Load_R",0,1291,functioncode=3,Type=243,SubType=23,Description="Current_Load_R",signed=True),
    ...
    # phase S
                ...
                Dev(58,"Current_Load_S",0,1299,functioncode=3,Type=243,SubType=23,Description="Current_Load_S",signed=True),
    ...
    # phase T
                ...
                Dev(64,"Current_Load_T",0,1307,functioncode=3,Type=243,SubType=23,Description="Current_Load_T",signed=True),
    ...
    # PV    
                ...
                Dev(70,"Current_PV1",0,1413,functioncode=3,Type=243,SubType=23,Description="Current_PV1"),
                ...
                Dev(73,"Current_PV2",0,1416,functioncode=3,Type=243,SubType=23,Description="Current_PV2"),
                ...
                Dev(76,"Current_PV3",0,1419,functioncode=3,Type=243,SubType=23,Description="Current_PV3"),
                ...
                Dev(79,"Current_PV4",0,1422,functioncode=3,Type=243,SubType=23,Description="Current_PV4"),
