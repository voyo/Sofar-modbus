...
#     def __init__(self,    ID,name,nod,register,functioncode: int = 3,options=None, Used: int = 1, Description=None, TypeName=None,Type: int = 0, SubType:int = 0 , SwitchType:int = 0  ):
        self.sensors = [
                ...
                Dev(15,"Frequency_grid",2,1156,functioncode=3,TypeName="Frequency",Description="Frequency_grid"),
   ...
   # phase R
                Dev(22,"Voltage_Phase_R",1,1165,functioncode=3,TypeName="Voltage",Description="Voltage_Phase_R"),
    ...
    # phase S
                Dev(31,"Voltage_Phase_S",1,1176,functioncode=3,TypeName="Voltage",Description="Voltage_Phase_S"),
    ...
    # phase T
                Dev(40,"Voltage_Phase_T",1,1187,functioncode=3,TypeName="Voltage",Description="Voltage_Phase_T"),
    ...
    # phase R
                Dev(51,"Voltage_Output_R",1,1290,functioncode=3,TypeName="Voltage",Description="Voltage_Output_R"),
    ...
    # phase S
                Dev(57,"Voltage_Output_S",1,1298,functioncode=3,TypeName="Voltage",Description="Voltage_Output_S"),
    ...
    # phase T
                Dev(63,"Voltage_Output_T",1,1306,functioncode=3,TypeName="Voltage",Description="Voltage_Output_T"),
    ...
    # PV    
                Dev(69,"Voltage_PV1",1,1412,functioncode=3,TypeName="Voltage",Description="Voltage_PV1"),
                ...
                Dev(72,"Voltage_PV2",1,1415,functioncode=3,TypeName="Voltage",Description="Voltage_PV2"),
                ...
                Dev(75,"Voltage_PV3",1,1418,functioncode=3,TypeName="Voltage",Description="Voltage_PV3"),
                ...
                Dev(78,"Voltage_PV4",1,1421,functioncode=3,TypeName="Voltage",Description="Voltage_PV4"),
