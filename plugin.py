...
#     def __init__(self,    ID,name,nod,register,functioncode: int = 3,options=None, Used: int = 1, Description=None, TypeName=None,Type: int = 0, SubType:int = 0 , SwitchType:int = 0  ):
        self.sensors = [
                ...
                Dev(15,"Frequency_grid",2,1156,functioncode=3,TypeName="Custom",Description="Frequency_grid",options={ "Custom" : "1;Hz"},multipler=0.01),
   ...
   # phase R
                Dev(22,"Voltage_Phase_R",1,1165,functioncode=3,TypeName="Voltage",Description="Voltage_Phase_R",multipler=0.1),
                Dev(23,"Current_Output_R",0,1166,functioncode=3,Type=243,SubType=23,Description="Current_Output_R",multipler=0.01),
                ...
                Dev(27,"Current_PCC_R",0,1170,functioncode=3,Type=243,SubType=23,Description="Current_PCC_R",multipler=0.01),
    ...
    # phase S
                Dev(31,"Voltage_Phase_S",1,1176,functioncode=3,TypeName="Voltage",Description="Voltage_Phase_S",multipler=0.1),
                Dev(32,"Current_Output_S",0,1177,functioncode=3,Type=243,SubType=23,Description="Current_Output_S",multipler=0.01),
                ...
                Dev(36,"Current_PCC_S",0,1181,functioncode=3,Type=243,SubType=23,Description="Current_PCC_S",multipler=0.01),
    ...
    # phase T
                Dev(40,"Voltage_Phase_T",1,1187,functioncode=3,TypeName="Voltage",Description="Voltage_Phase_T",multipler=0.1),
                Dev(41,"Current_Output_T",0,1188,functioncode=3,Type=243,SubType=23,Description="Current_Output_T",multipler=0.01),
                ...
                Dev(45,"Current_PCC_T",0,1192,functioncode=3,Type=243,SubType=23,Description="Current_PCC_T",multipler=0.01),
    ...
    # phase R
                Dev(51,"Voltage_Output_R",1,1290,functioncode=3,TypeName="Voltage",Description="Voltage_Output_R",multipler=0.1),
                Dev(52,"Current_Load_R",0,1291,functioncode=3,Type=243,SubType=23,Description="Current_Load_R",signed=True,multipler=0.01),
    ...
    # phase S
                Dev(57,"Voltage_Output_S",1,1298,functioncode=3,TypeName="Voltage",Description="Voltage_Output_S",multipler=0.1),
                Dev(58,"Current_Load_S",0,1299,functioncode=3,Type=243,SubType=23,Description="Current_Load_S",signed=True,multipler=0.01),
    ...
    # phase T
                Dev(63,"Voltage_Output_T",1,1306,functioncode=3,TypeName="Voltage",Description="Voltage_Output_T",multipler=0.1),
                Dev(64,"Current_Load_T",0,1307,functioncode=3,Type=243,SubType=23,Description="Current_Load_T",signed=True,multipler=0.01),
    ...
    # PV    
                Dev(69,"Voltage_PV1",1,1412,functioncode=3,TypeName="Voltage",Description="Voltage_PV1",multipler=0.1),
                Dev(70,"Current_PV1",0,1413,functioncode=3,Type=243,SubType=23,Description="Current_PV1",multipler=0.01),
                Dev(71,"Power_PV1",0,1414,functioncode=3,TypeName="Usage",Description="Power_PV1",signed=True),
                Dev(72,"Voltage_PV2",1,1415,functioncode=3,TypeName="Voltage",Description="Voltage_PV2",multipler=0.1),
                Dev(73,"Current_PV2",0,1416,functioncode=3,Type=243,SubType=23,Description="Current_PV2",multipler=0.01),
                Dev(74,"Power_PV2",0,1417,functioncode=3,TypeName="Usage",Description="Power_PV2",signed=True),
                Dev(75,"Voltage_PV3",1,1418,functioncode=3,TypeName="Voltage",Description="Voltage_PV3",multipler=0.1),
                Dev(76,"Current_PV3",0,1419,functioncode=3,Type=243,SubType=23,Description="Current_PV3",multipler=0.01),
                Dev(77,"Power_PV3",0,1420,functioncode=3,TypeName="Usage",Description="Power_PV3",signed=True),
                Dev(78,"Voltage_PV4",1,1421,functioncode=3,TypeName="Voltage",Description="Voltage_PV4",multipler=0.1),
                Dev(79,"Current_PV4",0,1422,functioncode=3,Type=243,SubType=23,Description="Current_PV4",multipler=0.01),
